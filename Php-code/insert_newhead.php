...
<div class="container">
   ...
   <div class="col-md-8 col-md-push-3" id="newhead">
    <h4>New Department Head</h4>
	<form role="form" method="post" action="insert_newheadcheck.php">
    ...
    <input type="text" class="form-control" id="exampleInputText1" placeholder="Department Abbreviation" name="dname">
    </div>
	<div class="form-group">
